...
$buffy .= '<div class="' . $td_social_enabled . '"><aside class="footer-text-wrap">';
    $buffy .= '<div class="block-title"><span style="color:white;">' . __td('VỀ CHÚNG TÔI', TD_THEME_NAME) . '</span></div>';
...
if(td_util::get_option('tds_footer_social') != 'no') {
	$buffy .= '<div class="td-pb-span4"><aside class="footer-social-wrap td-social-style-2">';
	    $buffy .= '<div class="block-title"><span style="color:white;">' . __td('THAM GIA THẢO LUẬN', TD_THEME_NAME) . '</span></div>';
	    ...
	    //     }
        // }
        $buffy .='<div class="fb-group" data-href="https://www.facebook.com/groups/congdongfnb.vn/" data-width="250" data-show-social-context="true" data-show-metadata="true"></div>';
	$buffy .= '</aside></div>';
}
