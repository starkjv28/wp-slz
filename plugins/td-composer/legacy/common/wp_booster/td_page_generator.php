...
<script type="application/ld+json">
    ...
    private static function author_breadcrumbs_array($part_cur_auth_obj, $skip_extra = false) {
        ...
        if ($skip_extra === false) {
            ...
            $breadcrumbs_array [] = array (
                'title_attribute' => '',
                'url' => '',
                'display_name' => __td('Tác giả', TD_THEME_NAME)
            );
        }
        ...
        $breadcrumbs_array [] = array (
            ...
            'display_name' => __td('Đăng bởi', TD_THEME_NAME) . ' ' . $part_cur_auth_obj->display_name
        );
        ...
        if (!empty($category_1_name)) {
            ...
            if ($td_paged > 1) {
                $breadcrumbs_array [] = array (
                    'title_attribute' => '',
                    'url' => '',
                    'display_name' =>  __td('Trang', TD_THEME_NAME) . ' ' . $td_paged
                );
            }
        }
    ...
    private static function search_breadcrumbs_array() {
        ...
        $breadcrumbs_array [] = array (
            'title_attribute' => '',
            'url' => '',
            'display_name' =>  __td('Tìm kiếm', TD_THEME_NAME)
        );
...
//            }
    ...
    static function pagenavi_init() {
        ...
        $pagenavi_options['pages_text'] = __td('Trang %CURRENT_PAGE% trên %TOTAL_PAGES%', TD_THEME_NAME);
    ...
    static function no_posts() {
        if (td_global::$custom_no_posts_message === false) {
            ...
            if (empty(td_global::$custom_no_posts_message)) {
                $buffy .= '<h2>' . __td('Chưa có bài viết', TD_THEME_NAME) . '</h2>';
            } else {
    ...
    static function get_breadcrumbs($breadcrumbs_array) {
        ...
        if (td_util::get_option('tds_breadcrumbs_show_home') != 'hide') {
            array_unshift($breadcrumbs_array, array(
                ...
                'display_name' => __td('Trang chủ', TD_THEME_NAME)
            ));
        }
