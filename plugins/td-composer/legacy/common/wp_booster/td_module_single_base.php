...
class td_module_single_base extends td_module {
    ...
    function get_author() {
        ...
        if (td_util::get_option('tds_p_show_author_name') != 'hide') {
            $buffy .= '<div class="td-post-author-name' . $post_author_no_dot . '"><div class="td-author-by">' . __td('Bởi', TD_THEME_NAME) . '</div> ';
    ...
    function get_next_prev_posts() {
        ...
        if (!empty($next_post) or !empty($prev_post)) {
            ...
            if (!empty($prev_post)) {
                ...
                $buffy .= '<div class="td-post-next-prev-content"><span>' .__td('Bài Viết Trước Đó', TD_THEME_NAME) . '</span>';
            ...
            if (!empty($next_post)) {
                ...
                $buffy .= '<div class="td-post-next-prev-content"><span>' .__td('Bài Viết Kế Tiếp', TD_THEME_NAME) . '</span>';
