...
define( 'CRESTA_FACEBOOK_MESSENGER_PLUGIN_VERSION', '1.1.6' );
...
function cresta_facebook_messenger_shortcode( $atts ) {
	...
	return '<div id="fb-root"></div>
			<script async defer crossorigin="anonymous" src="https://connect.facebook.net/'.esc_attr(trim($facebook_language)).'/sdk.js#xfbml=1&version=v3.3&autoLogAppEvents=1"></script>
			<script>
			(function($) {
			"use strict";
...
function add_cresta_facebook_messenger_box() {
	...
	if ($facebook_show_floating_box == 1 && cresta_facebook_messenger_show_floating()) {
		...
		<div id="cfmexist"></div>
		<div id="fb-root"></div>
		<script async defer crossorigin="anonymous" src="https://connect.facebook.net/<?php echo esc_attr(trim($facebook_language)); ?>/sdk.js#xfbml=1&version=v3.3&autoLogAppEvents=1"></script>
		<script>
		(function($) {
		"use strict";
			$(document).ready(function() {
